...
const CardFooter = (props) => {
    ...
    return type === 'course' ? (
      <footer className="flex gap-2 px-4 pb-4">
        ...
        <button className="relative flex justify-center items-center w-full py-1 border-yellow bg-yellow-500 text-stone-900 text-base font-semibold rounded-sm opacity-100">
          Add To Cart
        </button>
      </footer>
    ) : type === 'mocktest' ? (
